...
_MAIN_DB_PATH = os.environ.get("INKSIGHT_DB_PATH") or os.path.join(_DB_DIR, "inksight.db")
_CACHE_DB_PATH = os.environ.get("INKSIGHT_CACHE_DB_PATH") or os.path.join(_DB_DIR, "cache.db")
